...
Usage:
    python trainer.py --calib_dir CALIB_DIR [--n_epochs N_EPOCHS] [--lr LR] [--device {cpu, cuda}]
...
def train_model():
    ...
    parser.add_argument(
        ...
        default=r'C:\Users\23142\Desktop\perception\2_sensor_calibration\examples\calib_data_0512',
    )
    parser.add_argument(
    ...
    model_dir = os.path.join(calib_dir, "model2")

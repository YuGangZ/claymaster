...
calib_dir = os.path.join(os.path.dirname(__file__), "examples/calib_data_0512")

def prepare_data(calib_dir):
    # Argument Parsers
    ...
    parser.add_argument(
        ...
        default=os.path.join(calib_dir),
    )
    parser.add_argument(
        "-c",
        "--config_path",

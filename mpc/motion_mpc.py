...
class MotionControllerMPC(BaseMotionController):
    ...
    def calculate_mpc_velocity(self, current_state):
        ...
        if not self.mpc_enabled or self.current_14d_state is None:
        ...
        if self.mpc_step_counter >= self.mpc_update_interval:
            ...
            if latest_state_estimate is not None:
                self.current_14d_state = latest_state_estimate
            ...
            try:
                ...
                control = self.mpc_controller.control(self.current_14d_state, mpc_contact_info)
                ...
                print(f"  使用状态: {[f'{x:.3f}' for x in self.current_14d_state[:3]]}...")
    ...
    def _get_latest_state_estimate(self, current_state):
        ...
        try:
            if self.current_14d_state is None:
            ...
            if estimation_record and 'feature_14d' in estimation_record:
                return estimation_record['feature_14d']
    ...
    def _force_state_estimation(self, current_state):
        ...
        return MotionControllerUtils.get_14d_feature_vector(
    ...
    def estimate_and_save_superquadric(self, current_state):
        ...
        # Calculate 14D feature vector for MPC
        ...
        print(f"14维状态: {[f'{x:.3f}' for x in self.current_14d_state[:5]]}...")
    ...
    def print_state_info(self, current_state):
        ...
        MotionControllerUtils.print_state_info(
            ...
            current_14d_state=self.current_14d_state,

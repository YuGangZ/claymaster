...
if __name__ == "__main__":
    # 改进后的使用示例
    fuser = PointCloudFuser(r"C:\Users\23142\Desktop\project\perception\control0807\a")
    fused_pcd = fuser.fuse_clouds()
    # fuser.save_result("result3.ply")
